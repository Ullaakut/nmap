...
func WithTargets(targets ...string) ArgOption {
...
func WithTargetExclusion(target string) ArgOption {
	return func(s *Scanner) {
...
func WithTargetInput(inputFileName string) ArgOption {
	return func(s *Scanner) {
...
func WithTargetExclusionInput(inputFileName string) ArgOption {
	return func(s *Scanner) {
...
func WithRandomTargets(randomTargets int) ArgOption {
	return func(s *Scanner) {
